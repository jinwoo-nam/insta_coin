    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          child: Padding(
            padding:
                isMobileScreen ? EdgeInsets.all(3) : const EdgeInsets.all(20.0),
            child: Center(
              child: Container(
                padding:
                    isMobileScreen ? EdgeInsets.all(3) : EdgeInsets.all(25),
                        ...
                        child: Center(
                          child: InkWell(
                            onTap: () {
                              ...
                              viewModel.saveUserInfo(emailController.text,
                            ...
                            child: OnHoverDetect(
                              builder: (isHover) {
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isHover ? Color(0xff32c5d2) : null,
                                    border: Border.all(
